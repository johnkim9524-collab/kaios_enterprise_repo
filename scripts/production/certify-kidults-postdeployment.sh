...
values = {
    "certified_at": sys.argv[2],
    "health_http": int(sys.argv[3]),
    "portal_http": int(sys.argv[4]),
    "unauthenticated_collector_http": int(sys.argv[5]),
    "authenticated_collector_http": int(sys.argv[6]),
    "database_integrity": sys.argv[7],
    "database_sha256": sys.argv[8],
    "gateway_image_id": sys.argv[9],
    "scheduler_image_id": sys.argv[10],
}
checks = {
    "health": values["health_http"] == 200,
    "portal": values["portal_http"] == 200,
    "unauthenticated_collector": values["unauthenticated_collector_http"] == 401,
    "authenticated_collector": values["authenticated_collector_http"] == 200,
    "database_integrity": values["database_integrity"] == "ok",
}
...
payload = {
    ...
    "production_change_executed": True,
...
payload = {
    ...
    "observation_days": 30,
    "certification_archive": sys.argv[3],
