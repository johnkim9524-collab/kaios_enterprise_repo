...
const cells=[
  {
    cell_id:'R2_IDENTITY_REFERENCE_MULTISOURCE', evidence_class:'IDENTITY_CANONICAL_REFERENCE', sources:[met.source_id,smithsonian.source_id], independent_owner_count:2,
    rights_admission:'PASS_BOUNDED', canonical_entity_graph:'PASS_BOUNDED_INPUT', evidence_graph:'PASS_BOUNDED', market_event_graph:'NOT_APPLICABLE_IDENTITY_ONLY', engine_mesh:'PASS_BOUNDED_SHADOW_RUNTIME_EVIDENCE_BOUND', fallback_replacement:'PASS_TWO_INDEPENDENT_OWNERS',
    claim_ceiling:['OBJECT_IDENTITY','CATALOG_CONTEXT','REFERENCE_METADATA'], blocked_claims:['SOLD_TRANSACTION','CURRENT_MARKET_PRICE','LIQUIDITY','DEMAND']
  },
  {
    cell_id:'R2_HISTORICAL_TRANSACTION_PROVENANCE', evidence_class:'HISTORICAL_TRANSACTION_PROVENANCE', sources:[getty.source_id], independent_owner_count:1,
    rights_admission:'PASS_BOUNDED_CC0', canonical_entity_graph:'REQUIRES_OBJECT_IDENTITY_BINDING', evidence_graph:'PASS_BOUNDED_HISTORICAL', market_event_graph:'PASS_HISTORICAL_ONLY', engine_mesh:'PASS_BOUNDED_SHADOW_RUNTIME_EVIDENCE_BOUND', fallback_replacement:'CONCENTRATION_GAP_SINGLE_OWNER',
    claim_ceiling:['HISTORICAL_SALE_ACTIVITY','OWNERSHIP_TRANSFER_CONTEXT','HISTORICAL_VALUATION_CONTEXT'], blocked_claims:['CURRENT_MARKET_PRICE','CURRENT_LIQUIDITY','CURRENT_DEMAND','CURRENT_RANKING']
  },
  {
    cell_id:'R2_COLLECTAIO_DATED_SOLD_TRANSACTION', evidence_class:'DATED_OBSERVED_SOLD_TRANSACTION', sources:[x.sold.source.provider_id], independent_owner_count:1,
    scope_id:sold.scope_id, anchor:sold.anchor, canonical_item_slug:sold.canonical_item_slug, marketplace:sold.marketplace, observed_sold_event_count:sold.observed_sold_event_count, latest_event_date:sold.latest_event_date, condition_state:sold.condition_state,
    rights_admission:'PASS_DEV_SHADOW_INTERNAL_ONLY', canonical_entity_graph:'PASS_EXACT_ITEM_BINDING', evidence_graph:'PASS_DATED_SOLD_EVIDENCE', market_event_graph:'PASS_DATED_OBSERVED_SOLD_ONLY', engine_mesh:'PASS_BOUNDED_SHADOW_RUNTIME_EVIDENCE_BOUND', fallback_replacement:'CONCENTRATION_GAP_SINGLE_PROVIDER',
    claim_ceiling:[sold.claim_ceiling], blocked_claims:[...x.sold.prohibited_claims]
  }
];
const result={
  id:'kidults-owned-fabric-current-sold-lineage-r2', issue:560, production:'HOLD', status:'PARTIAL_EMPIRICAL_LINEAGE_WITH_DATED_SOLD_CELL', bounded_cell_count:cells.length, cells,
  deterministic_replay_basis:'BOUND_TO_EXISTING_ASI_SHADOW_OPERATING_EVIDENCE_PASS', current_sold_rights_admitted_source_count:1,
  current_market_cell_status:'DATED_OBSERVED_SOLD_AVAILABLE_NOT_CURRENT_PRICE_OR_LIQUIDITY',
  strict_dated_sold_lineage_proven:true, current_price_claim_sufficient:false, liquidity_claim_sufficient:false, time_to_sale_claim_sufficient:false,
  independent_current_sold_provider_redundancy:false,
  immutable_candidate:'BLOCKED_NOT_CREATED', track_b:'BLOCKED_EXACT_PAIR_ABSENT', e2e_exit_complete:false,
  remaining_blockers:['FINAL_ER_7_OF_7','BROADER_CURRENT_MARKET_CLAIM_SUFFICIENCY_OR_EXPLICIT_NARROW_CLAIM_SELECTION','INDEPENDENT_CURRENT_SOLD_REPLACEMENT_OR_CONCENTRATION_DECISION','IMMUTABLE_CANDIDATE_AND_EVIDENCE_PACKAGE','TRACK_B_EXACT_PACKAGE_ASSESSMENT'],
