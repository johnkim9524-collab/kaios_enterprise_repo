...
const suites = [
  ...
  'scripts/kidults/provider/validate-provider-outbound-email-approval-receipt-v1.mjs',
...
console.log(JSON.stringify({
  ...
  provider_written_email_only_negotiation: 'MANDATORY_POLICY_CONTROL_ONLY',
  provider_outbound_email_receipt_integrity: 'VERIFIED_CONTROL_ONLY_DO_NOT_DRAFT_OR_SEND',
  provider_email_live_approval_readback: 'NOT_IMPLEMENTED',
  provider_email_gmail_send_path_consumer: 'NOT_IMPLEMENTED',
  ...
  external_provider_routing: 'TRACK_Z_TO_KPMO_TO_FOUNDER',
