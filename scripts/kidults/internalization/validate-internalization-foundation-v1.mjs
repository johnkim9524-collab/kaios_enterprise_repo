...
const suites = [
  ...
  'scripts/kidults/internalization/validate-provider-removal-readiness-ledger-v1.mjs',
  'scripts/kidults/internalization/validate-provider-negotiation-packet-contract-v1.mjs'
];
