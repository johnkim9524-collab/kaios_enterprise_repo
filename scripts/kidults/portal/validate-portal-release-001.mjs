...
requireMarkers(store,['portal-read-contract-001','normalizeIntelligenceState','normalizeStructuralState','normalizeReleaseState','canonical_record_type','control_record_type','approved_browser_render:\'SIGNED_SAME_ORIGIN_SERVER_ENVELOPE_ONLY\'','state_only_browser_render:\'NO_PROJECTION_PAYLOADLESS\'','SAFE_STRUCTURAL_VERTICALS','kidults_proof_product_projection','PROJECTION_RECORD_TYPE_INVALID','NO_GOVERNED_PROJECTION','raw_provider_payloads:false','credentials:false','track_b_bypass:false','admitProofProductProjection','UNTRUSTED_BROWSER','releaseAuthority:\'HOLD\'','proof_product_admission:\'EXECUTED_BEFORE_RENDER\'','toctou_control:\'SERVER_RELOAD_AND_READMISSION_PER_REQUEST\''],'projection store');
