...
function walk(dir){
  for(const ent of fs.readdirSync(dir,{withFileTypes:true})){
    ...
    if(ent.isDirectory()) walk(p);
      ...
      if(rel==='coordination/kidults/redteam/d1-legacy-resource-policy-v1.json'||rel==='scripts/kidults/redteam/validate-d1-legacy-resource-policy-v1.mjs') continue;
...
console.log(JSON.stringify({suite:'D1_LEGACY_RESOURCE_POLICY_V1',result:'PASS'},null,2));
