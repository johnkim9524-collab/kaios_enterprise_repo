...
if(e.id!=='kidults-asi-common-crawl-host-expansion-v1'||!['SHADOW_COMMON_CRAWL_HOST_EXPANSION_COMPLETE','SHADOW_COMMON_CRAWL_HOST_EXPANSION_ZERO_RESULTS'].includes(e.status))fail('EXPANSION_IDENTITY');
...
const lane={lane_id:laneId,status:e.expanded_candidate_count>0?'SUCCESS_WITH_RESULTS':'SUCCESS_ZERO_RESULTS',observed_candidates:Number(e.expanded_candidate_count||0),new_candidates:accepted,error_count:Number(e.error_count??e.errors?.length??0),common_crawl_index_id:e.common_crawl_index_id||null};
