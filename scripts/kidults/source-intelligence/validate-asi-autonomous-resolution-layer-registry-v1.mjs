...
for (const marker of [
  ...
  'Reject false semantic PASS mutation',
  'Reject false rights ALLOW mutation',
  'Reject false Gate 1 PASS mutation',
  'Reject unresolved action mutation',
  'Reject false Evidence admission mutation',
  'Reject activated replacement profile mutation',
  'Reject candidate global-retirement mutation',
