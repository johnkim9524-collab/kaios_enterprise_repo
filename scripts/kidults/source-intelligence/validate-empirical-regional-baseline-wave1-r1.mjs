...
const totalObs=Number(x.coverage_debt_report.region_bound_observation_count||0);
const unmapped=Number(x.coverage_debt_report.unmapped_macroregion_observation_count||0);
...
console.log(JSON.stringify({status:'PASS',snapshot_id:x.snapshot_id,region_bound_source_assets:x.coverage_debt_report.region_bound_source_assets,region_bound_observation_count:totalObs,canonical_mapped_observation_count:mappedObs,unmapped_macroregion_observation_count:unmapped,verified_market_factors:verified,unknown_factor_assertions:unknown,shadow_delta:x.shadow_delta.status,production:x.production},null,2));
