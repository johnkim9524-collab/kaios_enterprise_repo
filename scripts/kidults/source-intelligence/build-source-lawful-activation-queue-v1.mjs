...
const deferredActionable = actionable.slice(program.activation_queue.max_source_purpose_packets);
...
const result = {
  ...
  deferred_actionable: deferredActionable,
...
console.log(`DEFERRED_ACTIONABLE=${deferredActionable.length}`);
