...
const cases=pairs.map((p,i)=>({
  ...
  reviewer_prompt_context:{shared_authoritative_mfr_model_code:p.modelCode,aircraft_manufacturer:p.a.projection.aircraft_manufacturer,aircraft_model:p.a.projection.aircraft_model,left_serial_number:p.a.projection.serial_number,right_serial_number:p.b.projection.serial_number,left_n_number_sha256:p.a.n_number_hash,right_n_number_sha256:p.b.n_number_hash,candidate_basis:'FAA_RELEASABLE_REGISTRY_SAME_AUTHORITATIVE_MANUFACTURER_MODEL_SERIES_CODE_DISTINCT_MANUFACTURER_ASSIGNED_SERIAL_NUMBERS'},
  label:null,
