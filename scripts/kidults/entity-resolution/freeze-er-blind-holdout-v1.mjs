...
if (dataset.dataset_class!=='REAL_WORLD_LABELED' || dataset.synthetic===true) throw new Error('REAL_WORLD_LABELED_DATASET_REQUIRED');
...
const artifact={
  id:`entity-resolution-blind-holdout-freeze-v1:${dataset.id??'unknown'}`,
