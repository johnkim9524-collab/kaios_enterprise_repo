...
const normalization={case_id:`wikidata-designer-maker-normalization-${selected.left.qid}`,case_class:'SAME_OBJECT_NORMALIZATION',identity_boundary:'SOURCE_RECORD',scope_id:STRATUM,expected:'MATCH',blind_holdout:false,left:{anchors:{SOURCE_RECORD:sourceAnchor},unique_keys:{object_id:selected.left.qid,accession_number:selected.left.inventory},entity_id:selected.left.qid,design_id:selected.design,designer_id:selected.designer,maker_id:selected.maker,label:label(left),source:'wikidata-structured-data'},right:{anchors:{SOURCE_RECORD:sourceAnchor},unique_keys:{object_id:selected.left.qid,accession_number:selected.left.inventory},entity_id:selected.left.qid,design_id:selected.design,designer_id:selected.designer,maker_id:selected.maker,label:String(label(left)).toLowerCase(),source:'wikidata-structured-data'},provenance_refs:[...baseProv,`wikidata:${selected.left.qid}:P31:${selected.design}`,`wikidata:${selected.left.qid}:P217:${selected.left.inventory}`],rights_state:'ALLOW',label_basis:'LIVE_WIKIDATA_REVALIDATES_ONE_INVENTORIED_PHYSICAL_EXEMPLAR_OF_AN_EXPLICIT_DESIGNER_MAKER_DESIGN',claim_ceiling:'DESIGNER_MAKER_SOURCE_RECORD_IDENTITY_ONLY'};
const sameDesign={case_id:`wikidata-designer-maker-same-design-${selected.left.qid}-${selected.right.qid}`,case_class:'SAME_DESIGN_DIFFERENT_OBJECT',identity_boundary:'CANONICAL_DESIGN',scope_id:STRATUM,expected:'MATCH',blind_holdout:true,left:{anchors:{CANONICAL_DESIGN:designAnchor},unique_keys:{object_id:selected.left.qid,accession_number:selected.left.inventory},entity_id:selected.left.qid,design_id:selected.design,source:'wikidata-structured-data'},right:{anchors:{CANONICAL_DESIGN:designAnchor},unique_keys:{object_id:selected.right.qid,accession_number:selected.right.inventory},entity_id:selected.right.qid,design_id:selected.design,source:'wikidata-structured-data'},provenance_refs:[...baseProv,`wikidata:${selected.left.qid}:P31:${selected.design}`,`wikidata:${selected.right.qid}:P31:${selected.design}`],rights_state:'ALLOW',label_basis:'TWO_DISTINCT_INVENTORIED_PHYSICAL_EXEMPLARS_ARE_INSTANCES_OF_THE_SAME_EXPLICIT_DESIGNER_MAKER_DESIGN',claim_ceiling:'DESIGNER_MAKER_CANONICAL_DESIGN_IDENTITY_ONLY'};
const hardNegative={case_id:`wikidata-designer-maker-physical-negative-${selected.left.qid}-${selected.right.qid}`,case_class:'HARD_NEGATIVE',identity_boundary:'PHYSICAL_OBJECT',scope_id:STRATUM,expected:'NO_MATCH',blind_holdout:true,left:{anchors:{PHYSICAL_OBJECT:`wikidata-inventory:${selected.left.qid}:${selected.left.inventory}`},unique_keys:{object_id:selected.left.qid,accession_number:selected.left.inventory},entity_id:selected.left.qid,design_id:selected.design,source:'wikidata-structured-data'},right:{anchors:{PHYSICAL_OBJECT:`wikidata-inventory:${selected.right.qid}:${selected.right.inventory}`},unique_keys:{object_id:selected.right.qid,accession_number:selected.right.inventory},entity_id:selected.right.qid,design_id:selected.design,source:'wikidata-structured-data'},provenance_refs:[`wikidata:${selected.left.qid}:P217:${selected.left.inventory}`,`wikidata:${selected.right.qid}:P217:${selected.right.inventory}`,`wikidata:${selected.left.qid}:P31:${selected.design}`,`wikidata:${selected.right.qid}:P31:${selected.design}`],rights_state:'ALLOW',label_basis:'DISTINCT_ENTITY_AND_INVENTORY_IDENTIFIERS_ESTABLISH_DISTINCT_PHYSICAL_EXEMPLARS_DESPITE_SHARED_DESIGN',claim_ceiling:'DESIGNER_MAKER_PHYSICAL_OBJECT_IDENTITY_ONLY'};
