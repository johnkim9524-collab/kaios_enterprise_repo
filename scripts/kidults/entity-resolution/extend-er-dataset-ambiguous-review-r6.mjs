...
const sparql='SELECT ?a ?b WHERE { ?a wdt:P460 ?b . FILTER(?a != ?b) } ORDER BY STR(?a) STR(?b) LIMIT 20';
...
if(!selected) throw new Error('P460 candidates failed live EntityData revalidation; fail closed.');
...
const ambiguousCase={
  ...
  rights_state:'ALLOW',
  label_basis:'WIKIDATA_P460_MODELS_SAID_TO_BE_THE_SAME_AS_WHILE_IDENTITY_MAY_BE_UNCERTAIN_OR_DISPUTED;_WITHOUT_A_STRONGER_EXACT_IDENTIFIER_AN_AUTO_MATCH_OR_AUTO_NO_MATCH_IS_NOT_JUSTIFIED',
