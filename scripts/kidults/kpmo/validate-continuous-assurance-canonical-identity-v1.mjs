...
assert(JSON.stringify(arlContract?.non_consumable_success_runtime_name_patterns) === JSON.stringify(['^KIDULTS ARL / recovery-[a-f0-9]{40}
...
]), 'ARL_NON_CONSUMABLE_SUCCESS_RULE');
