...
const evidence = {
  ...
  changed_file_classification: {count: manifest.predecessor_pull_request.changed_files,
    current_sold_changed: manifest.predecessor_pull_request.current_sold_changed},
