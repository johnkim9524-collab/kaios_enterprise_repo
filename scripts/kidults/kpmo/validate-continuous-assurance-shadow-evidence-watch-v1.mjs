...
const mutations = [
  ...
  ['and (.event=="schedule" or .event=="push")', 'and .event=="push"'],
  ['and (.event=="schedule" or .event=="push")', 'and .event=="schedule"'],
  ['and (.event=="schedule" or .event=="push")', 'and (.event=="schedule" or .event=="push" or .event=="pull_request")'],
...
console.log(JSON.stringify({
  ...
  protected_main_producer_events: ['schedule', 'push'],
