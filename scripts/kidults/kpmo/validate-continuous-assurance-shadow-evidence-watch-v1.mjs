...
const mutations = [
  ...
  ['.head_repository.full_name==$repo', '.head_repository.full_name!=$repo'],
  ['and (.event=="schedule" or .event=="push")', 'and (.event=="schedule" or .event=="push" or .event=="workflow_dispatch")'],
...
console.log(JSON.stringify({
  ...
  upstream_head_repository_bound: true,
  upstream_producer_events: ['schedule', 'push'],
  downstream_consumer_trigger: 'workflow_run',
