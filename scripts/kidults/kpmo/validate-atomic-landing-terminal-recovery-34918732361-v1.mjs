...
import {
  ...
  sha256,
  validateManifest,
} from './atomic-landing-terminal-recovery-34918732361-v1.mjs';

const manifestFile = 'coordination/kidults/kpmo/atomic-landing-terminal-recovery-34918732361-v1.json';
...
const approvedAt = '2026-09-15T04:10:00Z';
const expiresAt = '2026-09-15T05:10:00Z';
...
const approvalOptions = {
  ...
  currentMainSha,
  currentMainCommittedAt: '2026-09-15T04:00:00Z',
  manifestDigest,
  authorizationId,
  evaluationTime: '2026-09-15T04:20:00Z',
};
...
expectCode(() => selectApproval([approvalComment({updated_at: '2026-09-15T04:11:00Z'})], approvalOptions),
...
expectCode(() => selectApproval([approvalComment()], {...approvalOptions,
  evaluationTime: '2026-09-15T05:10:01Z'}), 'RECOVERY_APPROVAL_EXPIRED');
...
expectCode(() => assertHistoricalStatuses({statuses: [...historicalPayload.statuses,
  {...status(terminal, TERMINAL_CONTEXT), id: terminal.id + 1, created_at: '2026-09-15T04:00:00Z'}]}, manifest),
...
expectCode(() => assertRecoveryAbsent({statuses: [...historicalPayload.statuses, {
  ...
  target_url: 'https://example.invalid', created_at: '2026-09-15T04:00:00Z'}]}),
...
const evidence = {
  ...
  changed_file_classification: {count: 12, current_sold_changed: false},
