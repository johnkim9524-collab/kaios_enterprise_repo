...
export function selfTest(){
  ...
  return {test:'KPMO_CANONICAL_GENERATION_V3_SELF_TEST',state:'VERIFIED_PASS',canonical_members:25,append_only_payload_model:true,partial_generation_nonauthoritative:true,exact_main_and_hold:true,material_registry_bound:true,workflow_bootstrap_read_only:true,writes_reachable_from_workflow:false,workflow_roles_separated:true,writer_workflow_path:WRITER_WORKFLOW,mutations_rejected:5};
}
