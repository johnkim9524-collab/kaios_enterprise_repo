...
for (const dependency of ['CODE_LIBRARY', 'REGISTRY', 'IDENTITY_MAP', 'METHODOLOGY', 'RUNTIME', 'CLOCK_TIME_SOURCE', 'FX_SOURCE', 'PROVIDER_ORIGIN']) {
...
console.log('PASS: systemic/catastrophic Red-Team controls validated');
