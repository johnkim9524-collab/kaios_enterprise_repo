...
if (!repository || !token || !isSha(expectedMainSha)) {
...
const bodyMainSha = truthPhase === 'TRANSITION'
  ? expectedCanonicalBodyMainSha
  : (correctionPrValidation ? observedMainSha : expectedMainSha);
