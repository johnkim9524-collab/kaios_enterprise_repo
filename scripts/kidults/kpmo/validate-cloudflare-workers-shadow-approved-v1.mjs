...
const terminalPath = 'coordination/kidults/governance/receipts/CF-WORKERS-SHADOW-20260831-01-terminal.json';
...
ok(terminal.evidence_class === 'POST_HOC_CONTROL_RECORD_NOT_EXECUTION_ARTIFACT', 'TERMINAL_EVIDENCE_CLASS');
ok(terminal.run_artifact_present === false && terminal.empirical_evidence === false, 'TERMINAL_FALSE_EVIDENCE');

ok(workflow.includes("- '__consumed-cloudflare-shadow-v1-never-execute__'"), 'DORMANT_BRANCH_FILTER');
...
console.log(JSON.stringify({
  id: 'kidults-cloudflare-workers-shadow-v1-dormant-tombstone-validation-v2',
  state: 'VERIFIED_PASS',
  historical_run_id: 33410598558,
