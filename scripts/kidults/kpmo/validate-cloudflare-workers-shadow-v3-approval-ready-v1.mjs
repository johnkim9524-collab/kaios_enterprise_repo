...
// Absolute estate cardinality is owned by the complete secret-bearing inventory validator;
// this Cloudflare incident validator only binds its own zero-authority lanes plus registry self-consistency.
