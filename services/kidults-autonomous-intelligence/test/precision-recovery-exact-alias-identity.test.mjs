...
test('Nike Air Max exact recovery rejects model variants while preserving the canonical line entity', () => {
  const exact = evaluate('Nike Air Max', 'Nike Air Max', 'line of shoes released by Nike', ['athletic shoe', 'shoe', 'shoes', 'sneaker', 'sneakers']);
  const nearby = evaluate('Nike Air Max', 'Nike Air Max 90', 'line of shoes released by Nike', ['athletic shoe', 'shoe', 'shoes', 'sneaker', 'sneakers']);
  const company = evaluate('Nike Air Max', 'Nike Air Max', 'footwear company', ['athletic shoe', 'shoe', 'shoes', 'sneaker', 'sneakers']);
