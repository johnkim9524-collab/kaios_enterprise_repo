...
export const ASI_ENGINE_ALIGNMENT_STATE = 'ENFORCED' as const;
...
export const ASI_FLEET_LOGICAL_ENGINE: Readonly<Record<AsiFleetId, AsiLogicalEngineId>> = {
  DISCOVERY_COMMON_CRAWL_WDC: 'SOURCE_DISCOVERY_ENGINE',
  DISCOVERY_OVERTURE_MAPS: 'SOURCE_DISCOVERY_ENGINE',
  DISCOVERY_WIKIDATA: 'SOURCE_DISCOVERY_ENGINE',
  DISCOVERY_OPENSTREETMAP: 'SOURCE_DISCOVERY_ENGINE',
  DISCOVERY_GITHUB_HOMEPAGE: 'SOURCE_DISCOVERY_ENGINE',
  DISCOVERY_DATACITE_OPEN_RESEARCH: 'SOURCE_DISCOVERY_ENGINE',
  DISCOVERY_GLOBAL_NEWS_EVENTS: 'SOURCE_DISCOVERY_ENGINE',
  DISCOVERY_GOVERNMENT_REGIONAL_CATALOGS: 'SOURCE_DISCOVERY_ENGINE',
  DISCOVERY_ICANN_PUBLIC_ZONES: 'SOURCE_DISCOVERY_ENGINE',
  DISCOVERY_INTERNET_ARCHIVE_CONTINUITY: 'SOURCE_DISCOVERY_ENGINE',
  DISCOVERY_APPROVED_DIRECTORY_OUTBOUND_FRONTIER: 'SOURCE_DISCOVERY_ENGINE',
  DISCOVERY_OPTIONAL_LICENSED_GAP_FILL: 'SOURCE_DISCOVERY_ENGINE',
  SOURCE_SITE_IDENTITY_OWNER_LINEAGE: 'SOURCE_CLASSIFICATION_ENGINE',
  SOURCE_SCOPE_ROLE_CLASSIFICATION: 'SOURCE_CLASSIFICATION_ENGINE',
  SOURCE_REGION_LANGUAGE_CLASSIFICATION: 'SOURCE_CLASSIFICATION_ENGINE',
  SOURCE_MARKET_SEMANTICS_CLASSIFICATION: 'SOURCE_CLASSIFICATION_ENGINE',
  ...
  SOURCE_POOL_EVOLUTION: 'SOURCE_POOL_EVOLUTION_ENGINE',
};

export function asiLogicalEngineForFleet(fleetId: AsiFleetId): AsiLogicalEngineId {
  const logicalEngine = ASI_FLEET_LOGICAL_ENGINE[fleetId];
  if (!logicalEngine) throw new Error(`ASI_FLEET_LOGICAL_ENGINE_MISSING:${fleetId}`);
