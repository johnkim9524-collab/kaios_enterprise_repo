...
const checks = [
  ...
  ['SRE_LIVE_FALSE', sre.certificationBoundary?.liveOperationalCertified === false],
  ['SRE_SYNTHETIC_NOT_LIVE', sre.principles?.syntheticEvidenceDoesNotEqualLiveProof === true && sre.certificationBoundary?.simulationCanCertifyLiveOperations === false],
