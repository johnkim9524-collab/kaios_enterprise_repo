...
export interface RightsRegistryRecord {
  rightsId: string;
  sourceId: string;
...
export interface MethodologyRegistryRecord {
  ...
  effectiveAt?: string;
  supersedesMethodologyId?: string;
  inputContract: Record<string, unknown>;
  calculationContract: Record<string, unknown>;
...
export interface CommercialEligibility {
  ...
  sell: boolean;
  eligibleForPortal: boolean;
  eligibleForIndex: boolean;
  eligibleForReport: boolean;
  eligibleForApi: boolean;
  reasons: string[];
}
