...
Qualification and material KPMO review require the protected external attestation authority defined by the autonomous-independent-review trust boundary. Repository code, the subject KPMO, an implementer, or a reviewer may not manufacture qualification, independence, ACTIVE, STANDBY, quarantine cancellation, or reinstatement authority. Until the external trust root, a distinct hot qualified standby, and their positive canaries are verified, KPMO activation and non-SPOF claims remain fail-closed.
