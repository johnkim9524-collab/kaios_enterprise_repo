...
**보호된 main:** #1108 이후 `ea8bacc076ab228c3e7e334cd6cacbe86c3a3bdb`  
**Gate 상태:** C1 확립; C2 미완료; Production/Public/G5 `HOLD`  
**Evidence 참조:** #235, #236, #237, #238, #240, #256, #881, #921, #1013, #1074, #1080, #1106, #1107, #1108, #1113
...
현재 Protected main에는 #1106, #1113, #1107, #1108이 포함돼 있다. 검증된 현재 상태는 다음과 같다.
...
- v1 retirement는 서로 다른 두 건의 성공한 main-branch v2 cycle artifact가 readiness를 통과할 때까지 차단됨.

필수적인 two-cycle proof는 **확립되지 않았다**. #1109–#1112는 여전히 old-base/open 상태이며, 과거의 green 결과를 current-main proof로 재사용할 수 없다.
...
1. 과거의 SHA reference는 해당 시점의 snapshot으로 유지한다. 현재 protected-main 기준은 #1108 이후 `ea8bacc0…`이다.
...
- **동기화 상태:** `ALIGNED TO CANONICAL PROTECTED MAIN ea8bacc0 AT 2026-08-23 09:03 KST`.
